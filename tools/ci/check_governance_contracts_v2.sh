...
require_egrep() { grep -Eq "$2" "$1" || fail "Missing required governance pattern in $1: $2"; }
...
require_egrep contracts/repo/branch_strategy_v2.md 'integration/staging.*second truth branch'
