# STATUS PACKET REPORTING CONTRACT V1 — MINIMUM OPERATING VERSION (vMIN.1)

Status: active minimum baseline for RadioScale.
Source lineage: `mediastreamer/contracts/repo/status_packet_reporting_contract_v1.md`.
