# CHATGPT GIT EXCHANGE OPERATING STANDARD V1 — MINIMUM OPERATING VERSION (vMIN.1)

Status: active minimum baseline for RadioScale.
Source lineage: `mediastreamer/contracts/repo/chatgpt_git_exchange_operating_standard_v1.md`.
