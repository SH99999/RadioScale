# TRUTHFUL EXECUTION AND NEGATIVE ANSWER STANDARD V1 — MINIMUM OPERATING VERSION (vMIN.1)

Status: active minimum baseline for RadioScale.
Source lineage: `mediastreamer/contracts/repo/truthful_execution_and_negative_answer_standard_v1.md`.
