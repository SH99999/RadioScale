# UI UX STAGE B AUTONOMOUS LOOP STANDARD V1 — MINIMUM OPERATING VERSION (vMIN.1)

Status: active minimum baseline for RadioScale.
Source lineage: `mediastreamer/contracts/repo/ui_ux_stage_b_autonomous_loop_standard_v1.md`.
