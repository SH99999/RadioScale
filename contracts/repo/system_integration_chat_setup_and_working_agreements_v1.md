# SYSTEM INTEGRATION CHAT SETUP AND WORKING AGREEMENTS V1 — MINIMUM OPERATING VERSION (vMIN.1)

Status: active minimum baseline for RadioScale.
Source lineage: `mediastreamer/contracts/repo/system_integration_chat_setup_and_working_agreements_v1.md`.
