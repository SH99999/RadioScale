# SYSTEM INTEGRATION GOVERNANCE INDEX V7 — MINIMUM OPERATING VERSION (vMIN.1)

Status: active minimum baseline for RadioScale.
Source lineage: `mediastreamer/contracts/repo/system_integration_governance_index_v7.md`.
