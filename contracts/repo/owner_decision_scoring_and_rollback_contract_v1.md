# OWNER DECISION SCORING AND ROLLBACK CONTRACT V1 — MINIMUM OPERATING VERSION (vMIN.1)

Status: active minimum baseline for RadioScale.
Source lineage: `mediastreamer/contracts/repo/owner_decision_scoring_and_rollback_contract_v1.md`.
