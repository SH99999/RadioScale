# RELEASE INTAKE AND DELIVERY STATUS V1 — MINIMUM OPERATING VERSION (vMIN.1)

Status: active minimum baseline for RadioScale.
Source lineage: `mediastreamer/contracts/repo/release_intake_and_delivery_status_v1.md`.
