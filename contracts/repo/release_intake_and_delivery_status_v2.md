# RELEASE INTAKE AND DELIVERY STATUS V2 — MINIMUM OPERATING VERSION (vMIN.1)

Status: active minimum baseline for RadioScale.
Source lineage: `mediastreamer/contracts/repo/release_intake_and_delivery_status_v2.md`.
