# SYSTEM INTEGRATION GOVERNANCE INDEX V6 — MINIMUM OPERATING VERSION (vMIN.1)

Status: active minimum baseline for RadioScale.
Source lineage: `mediastreamer/contracts/repo/system_integration_governance_index_v6.md`.
