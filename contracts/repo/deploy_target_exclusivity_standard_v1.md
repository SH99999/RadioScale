# DEPLOY TARGET EXCLUSIVITY STANDARD V1 — MINIMUM OPERATING VERSION (vMIN.1)

Status: active minimum baseline for RadioScale.
Source lineage: `mediastreamer/contracts/repo/deploy_target_exclusivity_standard_v1.md`.
