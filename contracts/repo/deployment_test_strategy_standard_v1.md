# DEPLOYMENT TEST STRATEGY STANDARD V1 — MINIMUM OPERATING VERSION (vMIN.1)

Status: active minimum baseline for RadioScale.
Source lineage: `mediastreamer/contracts/repo/deployment_test_strategy_standard_v1.md`.
