# SYSTEM INTEGRATION ESCALATION CONTRACT V1 — MINIMUM OPERATING VERSION (vMIN.1)

Status: active minimum baseline for RadioScale.
Source lineage: `mediastreamer/contracts/repo/system_integration_escalation_contract_v1.md`.
