# ISSUE GOVERNANCE ROUTING STANDARD V1 — MINIMUM OPERATING VERSION (vMIN.1)

Status: active minimum baseline for RadioScale.
Source lineage: `mediastreamer/contracts/repo/issue_governance_routing_standard_v1.md`.
