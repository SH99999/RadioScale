# SYSTEM INTEGRATION GOVERNANCE INDEX V3 — MINIMUM OPERATING VERSION (vMIN.1)

Status: active minimum baseline for RadioScale.
Source lineage: `mediastreamer/contracts/repo/system_integration_governance_index_v3.md`.
