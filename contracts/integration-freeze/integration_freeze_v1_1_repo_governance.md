# INTEGRATION FREEZE V1 1 REPO GOVERNANCE — MINIMUM OPERATING VERSION (vMIN.1)

Status: active minimum baseline for RadioScale.
Source lineage: `mediastreamer/contracts/integration-freeze/integration_freeze_v1_1_repo_governance.md`.
